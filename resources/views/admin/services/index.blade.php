...
@push('title')
<title>Admin|Services|Content</title>
@endpush
@push('css')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6"><h3 class="card-title">All Service List Here...</h3></div>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('services.store') }}" id="servicesStore" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="img">
                                    Service Image
                                </div>
                                ...
                                <div class="input-group mb-3">
                                   <textarea name="service_description" placeholder="Description" class="form-control" cols="30" rows="5"></textarea>
                                </div>
