...
@push('title')
<title>Admin|Resume|Testimonial|Content</title>
@endpush
@push('css')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6"><h3 class="card-title">All Testimonial List Here...</h3></div>
...
<script>
    $(document).ready(function() {
        //  testimonial store ajax request
          $('body').on('submit', '#testimonial', function(e) {
              e.preventDefault();
        ...
        //    testimonial update ajax request
          $('body').on('submit', '#testimonialUpdate', function(e) {
              e.preventDefault();
              let get_route = $(this).attr('action');
              let form_data = new FormData($(this)[0]);
              $.ajax({
          ...
          //    testimonial delete ajax request
